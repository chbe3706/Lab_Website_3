...
const dbConfig = {
	host: 'localhost',
	port: 5433,  // For linux PSQL databases chack active port with \conninfo  !!
...
app.get('/player_info', function(req, res) {
	...
	db.any(players).then(function (rows) {
...
app.get('/player_info/post', function(req, res) {
  ...
  var playerInfo = "SELECT * FROM football_players WHERE name='"+player_name+"';";
